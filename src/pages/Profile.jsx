...
import { arrayRemove, doc, onSnapshot, snapshotEqual, updateDoc } from 'firebase/firestore'
const Profile = () => {
      ...
      <div>
        <div>
          <img
            ...
            src="https://assets.nflxext.com/ffe/siteui/vlv3/93da5c27-be66-427c-8b72-5cb39d275279/4979868a-17d6-44d7-b573-a8293d3f3b29/RW-en-20240226-popsignuptwoweeks-perspective_alpha_website_small.jpg"
            alt='//'
          />
          ...
          <div className=' absolute top-[20%] p-4 md:p-8'>
            ...
            <p className=' font-nsans-light to-gray-400 text-lg'>{user.email}</p>
          </div>
        </div>
        {/* movie row */}
            ...
            {movies.map((movie) => (
              ...
              <div key={movie.id} className=' relative w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block rounded-lg overflow-hidden cursor-pointer m-2'>
                ...
                <div className=' absolute top-0 left-0 w-full h-40 bg-black/80 opacity-0 hover:opacity-100'>
                  ...
                  <p><AiOutlineClose size={30} onClick={() => handleUnlikeShow(movie)} className=' absolute top-2 right-2' /></p>
                </div>
              </div>
